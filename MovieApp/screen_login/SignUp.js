...
export default SignUp = (props)=>{
    ...
    //1). 탭버튼의 라벨글씨들 변수
    let [tabs,setTabs]= useState(["전화번호","이메일"]) //초기값 설정 - 변수와 함수
    ...
    const signup = () =>{
        ...
        //이 예제에서는 그냥 테스트 목적이므로 서버에 데이터 보내는 것이 로그인화면으로 돌아가기
    ...
    return(
        <View style= {style.root}>
            ...
            <View style={style.content}>
                ...
                {
                    // JSX {}영역안에서는 연산자,변수,함수,객체 만 사용가능
                    // 제어문 사용불가
                    // if (tabIndex==1){}
                ...
                {
                    tabIndex==0 && <Text style={style.telMessage}>MovieApp의 업데이트 내용을 SMS로 수실할 수 있으며, 언제든 수신을 취소할 수 있습니다.</Text>
                }
